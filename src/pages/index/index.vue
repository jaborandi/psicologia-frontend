                    ...
                    <div  class="col-12 col-sm-6 col-md-3 comp-grid" >
                        <q-card  :flat="isSubPage" class="q-pa-md nice-shadow-16">
                            <div class="row justify-center q-col-gutter-md items-center">
                                ...
                                <div class="text-h6">Login de usuário</div>
                            </div>
                        </q-card>
                        <q-card  :flat="isSubPage" class=" q-my-md q-pa-md nice-shadow-16 nice-shadow-16">
                            <div >
                                <q-form ref="observer" @submit.prevent="startLogin()">
                                <q-input class="q-mb-md" label="Nome de usuário ou email" outlined dense placeholder="Nome de usuário ou email" v-model.trim="formData.username"  required="required" type="text" >
                                <template v-slot:prepend>
                                    <q-icon name="account_circle"></q-icon>
                                </template>
                                </q-input>
                                <q-input label="Senha"  class="q-mb-md" placeholder="Senha" required="required" v-model="formData.password" type="password">
                                <template v-slot:prepend>
                                ...
                                <div class="row q-mb-md">
                                    <div class="col-6">
                                        <q-checkbox v-model="rememberUser"> Lembre de mim</q-checkbox>
                                    </div>
                                    <div class="col-6">
                                        <q-btn to="/index/forgotpassword" class="text-danger" flat no-caps color="negative"> Redefinir senha</q-btn>
                                    </div>
                                </div>
                                <transition appear enter-active-class="animated bounceIn" leave-active-class="animated fadeOut">
                                    ...
                                    <div class="text-center">
                                        <q-btn label="Entrar"  :loading="loading" color="primary" icon="lock_open" class="full-width"  type="submit"> 
                                        </q-btn>
                                    </div>
                                    </q-form>
                                </div>
                            ...
                            <q-card  :flat="isSubPage" class="q-pa-md nice-shadow-16">
                                <div class="row justify-between items-center">
                                    ...
                                    <div class="col-auto">
                                        <q-btn icon="account_box" label="registo" color="positive" class="full-width" to="/index/register">
                                        </q-btn>
                                    </div>
                                </div>
                            </q-card>
